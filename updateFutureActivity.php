...
{
$set_idactivity=$_POST['setIdactivity'];
$new_date=$_POST['newDate'];
$new_location=$_POST['newLocation'];
$new_platform=$_POST['newPlatform'];
$new_todo_list=$_POST['newTodoList'];
$deleted='0';
mysqli_query($con,"UPDATE future_activity SET date='$new_date', location='$new_location', platform='$new_platform', to_do_list='$new_todo_list' WHERE fk_idactivity=$set_idactivity")or die(" Update future activity Query 2 is inncorrect..........");
header("location: futureActivity.php");
mysqli_close($con);
}
...
$found_futureActivity=mysqli_query($con,"SELECT * FROM future_activity WHERE fk_idactivity='$get_idactivity' AND deleted='0'")or die("update query is incorrect...");
list($fk_idactivity,$date,$location,$platform,$to_do_list,$deleted)=mysqli_fetch_array($found_futureActivity);
 }
?>
<!DOCTYPE html>
<html lang="en">
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                       ...
                       <h4 class="card-title">Update Future Activity</h4>
                       </div>
                     
                        <form class="forms-sample" action="updateFutureActivity.php" method="POST" >
                         <div class="row  d-flex justify-content-between">
                        <div class='form-group col-md-4'>
                       <label>Your Customer</label><br>
                        <input type="text" class="form-control" value="<?php echo $customerName?>" disabled>
                        <input type="hidden" class="form-control" name="setIdactivity" value="<?php echo $fk_idactivity?>" >
                        ...
                        <div class="row d-flex justify-content-between">
                          ...
                          <div class="form-group"><br>
                            <label for="exampleInputPassword1">New To Do List</label>
                            <br>
                            <Textarea type="text" class="form-control" name="newTodoList" ><?php echo $to_do_list?></textarea>
                          </div>
