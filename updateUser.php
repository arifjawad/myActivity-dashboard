...
$current_iduser=$_POST['userID'];
$new_Password=$_POST['userPassword'];
$deleted=0;
mysqli_query($con,"UPDATE user SET name='$new_UserName',password='$new_Password', deleted='$deleted' WHERE iduser='$current_iduser'")or die(" Update user Query 2 is inncorrect..........");
...
$found_user=mysqli_query($con,"SELECT * FROM user WHERE iduser='$iduser' AND deleted='0'")or die("Delete user query is incorrect...");
list($iduser,$name,$password,$deleted)=mysqli_fetch_array($found_user);
}
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <div class="col-md-8 d-flex align-items-stretch grid-margin">
                <div class="row flex-grow">
                  <div class="col-12">
                    <div class="card">
                      <div class="card-body">
                        <h4 class="card-title text-center">Update This User</h4>
                          <form class="forms-sample" action="updateUser.php" method="POST" id="user-form">              
                            <div class="form-group">
                            <label for="exampleInputEmail1">current user name:</label><br><h5> - <?php echo $name ?></h5><br>
                            <input type="hidden" class="form-control" name="userID" value='<?php echo $iduser ?>'>
                            </div>
                           <div class="form-group">
                             <label for="exampleInputEmail1">Set User name</label>
                            <input type="text" class="form-control" name="userName" placeholder="user name">
                          </div>
                          <div class="form-group">
                             <label for="exampleInputEmail1">Set User Password</label>
                            <input type="text" class="form-control" name="userPassword" placeholder="user password">
                          </div>
