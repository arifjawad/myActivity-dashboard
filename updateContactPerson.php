...
{
      $get_idcontact=$_GET['idcontact'];
      $get_idcustomer=$_GET['idcustomer'];

      $sql_load_contactPerson = "SELECT * FROM contact_person WHERE idcontact='$get_idcontact' AND fk_idcustomer = '$get_idcustomer'";
      ...
      if ($loaded_contactPerson->num_rows > 0) {
          while($row = $loaded_contactPerson->fetch_assoc()) {
            ...
            $found_fk_idcustomer=$row['fk_idcustomer'];
    ...
    if(isset($_POST['submit'])) 
      {
        $new_contactPerson_id=$_POST['contactPersonId'];
        $new_contactPerson_name=$_POST['contactPersonName'];
        $customerID=$_POST['customerID'];
        $new_contactPerson_hp=$_POST['contactPersonHp'];
        $new_contactPerson_email=$_POST['contactPersonEmail'];
        $new_contactPerson_birthday=$_POST['contactPersonBirthday'];
        $new_contactPerson_title=$_POST['contactPersonTitle'];
        $new_contactPerson_notes=$_POST['contactPersonNotes'];     
      mysqli_query($con,"UPDATE contact_person SET name='$new_contactPerson_name',hp='$new_contactPerson_hp',email='$new_contactPerson_email', birthday='$new_contactPerson_birthday',title='$new_contactPerson_title',notes='$new_contactPerson_notes' WHERE fk_idcustomer='$customerID' AND deleted ='0'")or die(" Update  Query 2 is inncorrect.........."); 
                      ...
                      <div class='card'>
                        ...
                        <div class='text-center'>
                         <h4 class='card-title'>Contact Person</h4>
                          ...
                          <form class='forms-sample'  action='updateContactPerson.php' method='POST'>
                            <div class='form-group'>
                              <label for='exampleInputName1'>Name</label>
                              <input type='text' class='form-control' name='contactPersonName' value='<?php echo $contactPerson_name?>'>
                              <input type='hidden' class='form-control' name='contactPersonId' value='<?php echo $contactPerson_id?>'>
                              <input type='hidden' class='form-control' name='customerID' value='<?php echo  $found_fk_idcustomer?>'>
                            </div>
                            <div class='form-group'>
                              <label for='exampleInputEmail3'>HP</label>
                              <input type='text' class='form-control' name='contactPersonHp' value='<?php echo $contactPerson_hp?>'>
                            </div>
                            <div class='form-group'>
                              <label for='exampleInputEmail3'>Email address</label>
                              <input type='email' class='form-control' name='contactPersonEmail' value='<?php echo $contactPerson_email?>'>
                            </div>
                            <div class='form-group'>
                              <label for='exampleInputName1'>Birthday</label>
                              <input type='date' class='form-control' name='contactPersonBirthday' value='<?php echo $contactPerson_birthday?>'>
                            </div>
                            <div class='form-group'>
                              <label for='exampleInputName1'>Title</label>
                              <input type='text' class='form-control' name='contactPersonTitle' value='<?php echo $contactPerson_title?>'>
                            </div>
                           <div class='form-group'>
                              <label for='exampleInputEmail3'>Notes</label>
                              <textarea type='text' class='form-control' name='contactPersonNotes'><?php echo $contactPerson_notes?></textarea>
                            </div>
                            <div class='text-center'>
